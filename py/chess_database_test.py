...
class DatabaseTest(unittest.TestCase):
    ...
    def dont_test_position_search(self):
        d = ChessDatabase('/Users/shiv/chess/kivy-chess/book/polyglot_index.db')
        fen = "rnbqkb1r/pppp1ppp/4pn2/8/2PP4/5N2/PP2PPPP/RNBQKB1R b KQkq - 1 3"
        pos_hash = sf.key(fen, [])
        game_list = d.query_position(pos_hash, max_games=10)
        # print game_list

        game = d.open_game(d.load_game(int(game_list[0])))
        # print game.headers
        # print game.moves
